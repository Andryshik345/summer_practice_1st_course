...
# Класс с ф-циями для обработки текста
class StringFileOperations:
    ...
    def search_string(self, needed, change):
        text = self.read_file()
   ...
   try:
    ...
    if (choose == 1):
        ...
        if (needed and change):
            StringFileOperations().search_string(needed=needed, change=change)
        else:
            print("Пустой ввод.")
    ...
    # Метод "Нахождение частоты повторения строки"
        ...
        needed = input("Найти: ")
        if (needed):
            StringFileOperations().count_lines(needed=needed)
        else:
            print("Пустой ввод.")
    ...
    # Метод "Вставка заданной строки после найденной"
        ...
        needed = input("Найти: ")
        if (needed):
            StringFileOperations().paste_str(needed=needed)
        else:
            print("Пустой ввод.")
